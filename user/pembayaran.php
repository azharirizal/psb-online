...
<div class="col-lg-12">
<div class="jumbotron">
<form class="form-inline" action="pembayaran_proses.php" id="pembayaran" method="post" enctype="multipart/form-data" role="form">
  ...
  <input type="text" class="form-control number" name="jumlah" placeholder="Biaya Pendaftaran : Rp.250000" required>
  </div><br>
  <div class="form-group">     
  ...
  <div class="form-group">
  <label class="text-success">UPLOAD BUKTI PEMBAYARAN : </label>
  </div><input type="file" name="gambar"><br>
  <div class="form-group">
