  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Cetak Data Pembayaran Perperiode
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Cetak Data Pembayaran Perperiode</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-body">
             <form role="form" method="post" action="pages/cetak/cetak_laporan_pembayaran.php" target="_blank">
              <!-- Date -->
