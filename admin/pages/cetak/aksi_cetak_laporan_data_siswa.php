...
<br>
<div style="text-align:right;font-weight:bold;font-size:20px;margin:0 auto;width:100%;">Laporan Per-Periode Data Siswa</div>
...
$sql = mysql_query("SELECT * FROM psb_calon_siswa INNER JOIN psb_biodata ON psb_calon_siswa.nisn=psb_biodata.nisn WHERE (psb_calon_siswa.tgl_daftar BETWEEN '$format_tawal' AND '$format_takhir')")or die(mysql_error());
...
if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
    while($data = mysql_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
     ?>
      ...
      <td align="center"><?php echo $data['tmp_lahir'],', ',$data['tgl_lahir'];?></td>
